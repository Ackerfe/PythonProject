...
def generate_quiz_json(questions, answers, output_path):
    ...
    quiz_data_additional = {
        "id": "2",
        "title": "ISTQB Sample Exam Additional Questions",
        "time": "60 minutes",
        "questionList": []
    }
    ...
    for question in questions:
        ...
        if question_id in answers:
            ...
            # Assign explanation as a string instead of a dictionary
            question_data["explanation"] = answers[question_id]["explanation"]["full"]
        ...
        if question_id.startswith("A"):  # This is an additional question (A1, A2, A3, etc.)
            quiz_data_additional["questionList"].append(question_data)
        else:  # Regular questions (1, 2, 3, etc.)
            quiz_data_regular["questionList"].append(question_data)

    # Combine both sets of questions into one list of dictionaries
    final_quiz_data = [quiz_data_regular, quiz_data_additional]
